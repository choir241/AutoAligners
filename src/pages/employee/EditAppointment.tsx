...
import {
  ...
  checkDate,
} from "../../hooks/EditAppointmentHooks";
          ...
          <section className="section-1 flex flex-col alignCenter">
            ...
            <div className="flex flex-col alignCenter contact">
              ...
              {TextBoxInput({
                ...
                placeholder: data.comment || "Additional Comments",
              })}
            </div>
          </section>
        </div>
