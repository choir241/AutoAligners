...
export const ServiceEstimate = lazy(()=>import("./pages/guest/ServiceEstimate"));
export const ManageAppointments = lazy(()=>import("./pages/employee/ManageAppointments"));
export const EditAppointment = lazy(()=>import("./pages/employee/EditAppointment"));
...
export const EmployeeSettings = lazy(()=>import("./pages/employee/EmployeeSettings"));
export const Inventory = lazy(()=>import("./pages/employee/Inventory"));
export const InventoryShop = lazy(()=>import("./pages/employee/InventoryShop"));
